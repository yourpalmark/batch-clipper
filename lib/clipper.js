...
function preprocessHtml(doc) {
  ...
  // Confluence draw.io / Gliffy diagram macros — these are interactive diagram embeds
  // that don't render in body.view HTML. Remove the entire macro wrapper rather than
  // letting garbled macro parameters ("trueomni matchingfalseautotoptrue138612") bleed into content.
  try {
    ...
    for (const sel of diagramSelectors) {
