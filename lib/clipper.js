...
async function clipPage({
  ...
  try {
    ...
    // Defuddle has no built-in Confluence support — without a contentSelector it falls
    // back to <body> and picks up nav/sidebar noise. Pass the Confluence content selector
    // explicitly so it targets the main content area directly.
